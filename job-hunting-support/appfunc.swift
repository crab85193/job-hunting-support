...
//        guard let url = URL(string: "http://10.0.4.175/api/select-user.php?id="+"2") else { return }
        guard let url = URL(string: "http://job-app.st.ie.u-ryukyu.ac.jp/user/select.php") else { return }
    ...
    /*
    func getUserinfo(completion: user, name: String, password: String) {
//        guard let url = URL(string: "http://10.0.4.175/api/select-user.php?id="+"2") else { return }
        guard let url = URL(string: "http://job-app.st.ie.u-ryukyu.ac.jp/user/select.php?/id=" + name + "&password=" + password) else { return }
